...
<p align="left">
  ...
  <!-- OpenAI -->
  <img src="https://upload.wikimedia.org/wikipedia/commons/6/66/OpenAI_logo_2025_%28symbol%29.svg?utm_source=commons.wikimedia.org&utm_campaign=index&utm_content=original" width="40" alt="OpenAI Logo"/>
...
<p align="left">
  ...
  <!-- Pinecone logo (community SVG source) -->
  ...
  <img src="https://github.com/chroma-core/chroma/blob/main/docs/assets/chroma-wordmark-color.png#gh-light-mode-only" width="250" alt="Chroma Logo"/>
...
### ☁️ Cloud, Containers & Observability
<p align="left">
  <img src="https://skillicons.dev/icons?i=aws,azure,docker,kubernetes,prometheus,grafana" />
...
* **GenAI & LLM-Fundamentals:** LLM Fundamentals, Tokenization & Embeddings, Word2Vec, fastText, Bi-LSTM, Autoencoders, Variational Autoencoders (VAE), Transformer Architectures, BERT, GPT, T5, BART, LLaMA, Prompt Engineering
...
* **AI Observability:** OpenTelemetry, Prometheus, Grafana, Loki, Tempo, Promtail, Datadog
...
⭐ *Building scalable systems, self-healing infrastructure, and local-LLM powered platforms*
